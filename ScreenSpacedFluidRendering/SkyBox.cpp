...
void SkyBox::Load()
{
	...
	std::wstring imageFilename [] = {
		L"envmap_miramar/miramar_bk.tga",
		L"envmap_miramar/miramar_ft.tga",

		L"envmap_miramar/miramar_dn.tga",
		L"envmap_miramar/miramar_up.tga",
		
		L"envmap_miramar/miramar_lf.tga",
		L"envmap_miramar/miramar_rt.tga",
	};
